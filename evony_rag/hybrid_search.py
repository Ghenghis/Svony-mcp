...
class HybridSearch:
    ...
    def load_index(self, index_path: Path = INDEX_PATH) -> bool:
        ...
        try:
            ...
            # Load embedding model (suppress library output for MCP)
